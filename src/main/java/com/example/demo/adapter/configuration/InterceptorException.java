...
public class InterceptorException {
    ...
    public ResponseEntity<ProblemDetail> handlerMatchException(UserException e) {
    ...
    private ResponseEntity<ProblemDetail> validation(MethodArgumentNotValidException e) {
